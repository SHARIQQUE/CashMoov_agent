 ...
 */
public class AutoFormatEditTextFrench extends EditText {
    ...
    public AutoFormatEditTextFrench(Context context) {
        super(context);
        initialize();
    }

    public AutoFormatEditTextFrench(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize(attrs);
    }

    public AutoFormatEditTextFrench(Context context, AttributeSet attrs, int defStyleAttr) {
