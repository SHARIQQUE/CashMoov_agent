                        ...
                        public void success(JSONObject jsonObject) {
                            ...
                            if (jsonObject != null) {
                                ...
                                if(jsonObject.optString("resultCode", "N/A").equalsIgnoreCase("0")){
                                    ...
                                    spinnerDialogCountry = new SpinnerDialog(phnoregistrationccreenC, countryList, getString(R.string.val_select_country), R.style.DialogAnimations_SmileWindow, getString(R.string.cancel));// With 	Animation
