...
public class TransactionListAdapterNew extends RecyclerView.Adapter<TransactionListAdapterNew.ViewHolder>{
    private Context context;
    private List<TransactionModel> transactionList = new ArrayList<>();
    private TransactionListLisners transactionListLisners;

    public TransactionListAdapterNew(Context context, List<TransactionModel> transactionArrayList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View listItem= layoutInflater.inflate(R.layout.item_transaction_list_new, parent, false);
