...
import com.agent.cashmoovui.adapter.SearchAdapteRecycleDetails;
...
public class TransactionHistoryAgentRecycleClick extends LogoutAppCompactActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    SearchAdapteRecycleDetails adpter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.transaction_history_agent_recycleclick);
    ...
    try {
        ...
        edittext_search.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (new InternetCheck().isConnected(TransactionHistoryAgentRecycleClick.this)) {
                    ...
                    Toast.makeText(TransactionHistoryAgentRecycleClick.this, getString(R.string.please_check_internet), Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        {
            Toast.makeText(TransactionHistoryAgentRecycleClick.this,e.toString(),Toast.LENGTH_LONG).show();
            e.printStackTrace();
            finish();
        }
    ...
    private void api_transactionHistory_agent() {
        ...
        String code_walletOwnerChildList =  MyApplication.getSaveString("code_walletOwnerChildList", TransactionHistoryAgentRecycleClick.this);

        API.GET_TRANSFER_DETAILS("ewallet/api/v1/walletOwner/all/parent/"+code_walletOwnerChildList,languageToUse,new Api_Responce_Handler() {
                ...
                try {
                    ...
                    if(resultCode.equalsIgnoreCase("0")) {
                        ...
                        if(jsonObject.has("walletOwner")) {
                            ...
                            if(jsonObject1_walletOwner.has("walletOwner")) {

                                JSONArray jsonArray = jsonObject1_walletOwner.getJSONArray("walletOwner");
                        ...
                        recyclerView_agent.setLayoutManager(new LinearLayoutManager(TransactionHistoryAgentRecycleClick.this));

                        adpter= new SearchAdapteRecycleDetails(TransactionHistoryAgentRecycleClick.this,arrayList_modalDetails);
                        recyclerView_agent.setAdapter(adpter);

                    }

                    else {
                        Toast.makeText(TransactionHistoryAgentRecycleClick.this, resultDescription, Toast.LENGTH_LONG).show();
            ...
            public void failure(String aFalse) {
                ...
                MyApplication.hideLoader();
                Toast.makeText(TransactionHistoryAgentRecycleClick.this, aFalse, Toast.LENGTH_SHORT).show();
                finish();
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.search_imageView:
                ...
                Toast.makeText(TransactionHistoryAgentRecycleClick.this, "---------search_imageView-------", Toast.LENGTH_LONG).show();
