...
public class SubscriberInfoModelNew {
    ...
    public SubscriberInfoModelNew(String transactionId, String requestTime, String responseTime, String resultCode, String resultDescription, Subscriber subscriber) {
    ...
    public SubscriberInfoModelNew(String transactionId, String requestTime, String responseTime, String resultCode, String resultDescription, Customer customer) {
        this.transactionId = transactionId;
        this.requestTime = requestTime;
        this.responseTime = responseTime;
        this.resultCode = resultCode;
