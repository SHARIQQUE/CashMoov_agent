...
public class SearchAdapteRecycleDetails extends RecyclerView.Adapter<SearchAdapteRecycleDetails.ViewHolder> {
    String finalDate;
    ...
    public SearchAdapteRecycleDetails(Context context, ArrayList<UserDetailAgent> arrayList_modalUserData) {
...
//        });
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View listItem = layoutInflater.inflate(R.layout.search_transaction_agent_recycle, viewGroup, false);
