...
public class SenderCurrenyDetailsAdapter extends BaseAdapter {

    Context context;
    ArrayList<SenderCurrencyModal> list;
    LayoutInflater inflter;

    public SenderCurrenyDetailsAdapter(Context applicationContext, ArrayList<SenderCurrencyModal> listData) {
...
//        Collections.sort(arrayList, new StudentDateComparator());
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        names.setText(list.get(i).getCurrencyName_sender());
