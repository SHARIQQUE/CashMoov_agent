...
public class ReceiverCurrenyDetailsAdapter extends BaseAdapter {

    Context context;
    ArrayList<ReceiverCurrencyModal> list;
    LayoutInflater inflter;

    public ReceiverCurrenyDetailsAdapter(Context applicationContext, ArrayList<ReceiverCurrencyModal> listData) {
...
//        Collections.sort(arrayList, new StudentDateComparator());
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        names.setText(list.get(i).getCurrencyName_reciver());
