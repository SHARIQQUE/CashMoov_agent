...
public class CustomeBaseAdapterReceiverCountry extends BaseAdapter {

    Context context;
    ArrayList<String> list;
    LayoutInflater inflter;

    public CustomeBaseAdapterReceiverCountry(Context applicationContext, ArrayList<String> listData) {
