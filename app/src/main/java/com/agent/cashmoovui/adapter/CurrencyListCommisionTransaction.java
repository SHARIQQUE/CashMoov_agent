...
public class CurrencyListCommisionTransaction extends BaseAdapter {

    Context context;
    ArrayList<CurrencyModel> list;
    LayoutInflater inflter;

    public CurrencyListCommisionTransaction(Context applicationContext, ArrayList<CurrencyModel> listData) {
...
//        Collections.sort(arrayList, new StudentDateComparator());
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        names.setText(list.get(i).currencyName);
