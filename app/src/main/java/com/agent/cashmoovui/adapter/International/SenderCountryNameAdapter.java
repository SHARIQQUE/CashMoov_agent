...
public class SenderCountryNameAdapter extends BaseAdapter {

    Context context;
    ArrayList<SenderCountryModal> list;
    LayoutInflater inflter;

    public SenderCountryNameAdapter(Context applicationContext, ArrayList<SenderCountryModal> listData) {
...
//        Collections.sort(arrayList, new StudentDateComparator());
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        names.setText(list.get(i).getCountryName_sender());


//        if(i==0){
//
//            names.setText("--Select RTO--");
//        }
//        else {
//            names.setText(list.get(i-1).getCountryName_sender());
//        }
