...
public class CustomeBaseAdapterReceiveCurrency extends BaseAdapter {

    Context context;
    ArrayList<String> list;
    LayoutInflater inflter;

    public CustomeBaseAdapterReceiveCurrency(Context applicationContext, ArrayList<String> listData) {
