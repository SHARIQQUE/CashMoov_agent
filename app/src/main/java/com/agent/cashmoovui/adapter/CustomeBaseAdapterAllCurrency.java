...
public class CustomeBaseAdapterAllCurrency extends BaseAdapter {

    Context context;
    ArrayList<String> list;
    LayoutInflater inflter;

    public CustomeBaseAdapterAllCurrency(Context applicationContext, ArrayList<String> listData) {
